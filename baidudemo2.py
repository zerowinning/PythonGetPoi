...
url_amap = 'http://api.map.baidu.com/place/v2/search?query=装修&tag=装修&page_size=20&page_num=0&scope=2&region=沈阳市&coord_type=3&output=json&ak=8VUjfqGwgnHwEZLxwPpnZvO1Sgeq2HFO'
page_size = 20  # 每页条目数，最大限制为20条
page_index = r'page_num=1'  # 显示页码
total_record = 0  # 定义全局变量，总行数，百度有限制不能超过400条
# Excel表头
hkeys = ['id', '名称', '类型', '详情网址', '地址', '联系电话', '北纬', '东经']
# 获取数据列
